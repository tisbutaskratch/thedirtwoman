...
export const roles: Role[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Helped run the Women in Engineering and Women at Loop employee resource groups, and took the case for career growth to executive leadership.",
    ],
    tags: [
      "Team leadership",
      "Delivery process",
  ...
  },
  {
    ...
    highlights: [
      ...
      "The person the team came to on badge scanning, workflow auditing, and code caching to cut database reads.",
...
export const competencies: Competency[] = [
  ...
  },
  {
    ...
    evidence: [
      "Reviewed heavily, and left comments rather than approvals.",
...
export const contactLinks: ContactLink[] = [
  {
    label: "Email",
    value: "sabadwtech@protonmail.com",
    href: "mailto:sabadwtech@protonmail.com",
    icon: "feedback",
  },
  {
    label: "LinkedIn",
